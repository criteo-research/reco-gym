        ...
        for u in range(num_step_users):
            ...
            while not done:
                ...
                if reward:
                    ...
                    rewards[EvolutionCase.ACTIONS][action['a']][-1] += reward #HH
                else:
                    if 'greedy' in action and action['greedy']:
                        failures_greedy += 1
                    failures += 1
...
def _collect_stats(args):
    ...
    :return: a vector of Sales for these confidence values:
        0th: Q0.500
        1st: Q0.025
        snd: Q0.975
    """
...
def verify_agents(env, number_of_users, agents): ##H
    stat = {
        'Agent': [],
        '0.025': [],
        '0.500': [],
